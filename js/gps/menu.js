var MainMenu = [
	...
	{href: 'javascript:void(0)', title: locale.menuMap, submenu: [
	...
	{href: 'javascript:void(0)', title: locale.menuPlanning, submenu: [
		{href: 'calendar.html', title: locale.menuCalendar},
		{href: 'routes-points.html', title: locale.menuRoutesPoints}
	]},
	{href: 'javascript:void(0)', title: locale.menuReports},
